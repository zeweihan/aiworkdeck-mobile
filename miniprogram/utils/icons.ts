...
const P = {
  ...
  gear:
    ...
    '<path d="M12 1.8a2 2 0 0 1 2 2v.4a1.6 1.6 0 0 0 2.7 1.1l.3-.3a2 2 0 1 1 2.8 2.8l-.3.3a1.6 1.6 0 0 0 1.1 2.7h.4' +
    'a2 2 0 1 1 0 4h-.4a1.6 1.6 0 0 0-1.1 2.7l.3.3a2 2 0 1 1-2.8 2.8l-.3-.3a1.6 1.6 0 0 0-2.7 1.1v.4a2 2 0 1 1-4 0v-.4' +
    'a1.6 1.6 0 0 0-2.7-1.1l-.3.3a2 2 0 1 1-2.8-2.8l.3-.3A1.6 1.6 0 0 0 4.2 14h-.4a2 2 0 1 1 0-4h.4a1.6 1.6 0 0 0 1.1-2.7' +
    'l-.3-.3a2 2 0 1 1 2.8-2.8l.3.3A1.6 1.6 0 0 0 10 4.2v-.4a2 2 0 0 1 2-2z"/>',
}
