...
export const DATA_FILES = ['transfer-state.json', 'strings.json', 'tokens.json', 'capabilities.json', 'products.json']
...
export function loadContract(root) {
  return {
    ...
    products: readJson(root, 'products.json'),
...
export function outputs(c) {
  ...
  return new Map([
    ...
    ['miniprogram/utils/contract/products.ts', renderTsProducts(c)],
